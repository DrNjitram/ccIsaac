...
ccConsumables.methods = {
    ...
    quantity_add_coin = ccConsumables.AddCoin,
    quantity_remove_coin = ccConsumables.RemoveCoin,
    quantity_add_bomb = ccConsumables.AddBomb,
    quantity_remove_bomb = ccConsumables.RemoveBomb,
    quantity_add_key = ccConsumables.AddKey,
    quantity_remove_key = ccConsumables.RemoveKey,
	...
	quantity_give_blue_flies = ccConsumables.AddFlies,
	quantity_give_blue_spider = ccConsumables.AddSpiders,
    quantity_give_random_dip = ccConsumables.AddDips,
